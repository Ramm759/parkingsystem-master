...
public class DBConstants {
    ...
    // #STORY2 : renvoie zéro si le client n'a aucun enregistrement, elle renvoie un nombre différent de 0 si le client a déjà payé au moins une fois
    // on supprime également les durées < 30 minutes
